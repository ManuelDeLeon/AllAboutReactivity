...
Template.example8.events({
  'click #example8-runExample': function () {
    ...
    computation = Tracker.autorun(function () {
      console.log("Executing FIRST dependency.depend()");
      dependency.depend();
      console.log(new Date());
    });

    Tracker.autorun(function () {
      console.log("Executing SECOND dependency.depend()");
      dependency.depend();
      console.log(new Date());
    });
  },
  ...
  'click #example8-noAutorun': function () {
    console.log("================");
  ...
  'click #example8-stopComputation': function () {
    console.log("================");
    console.log("Executing computation.stop()");
    computation.stop();
  },

  'click #example8-addLogs': function () {
    if (!realDependency) {
  ...
  'click #example8-removeLogs': function () {
    if (realDependency) {
